 ...
 *
 * This code is configuring and initializing the MCU the "hard way",
 * by transposing the code generated by STM32Cube MX program from C to Rust.
 * There's more Rust-style ways of doing this, but hides some important details,
 * which I don't really like. For an example about how to initialize the MCU this way:
